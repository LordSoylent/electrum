...
;Variables
  ...
  !define PRODUCT_NAME "Electrum-Syscoin"
  !define PRODUCT_WEB_SITE "https://github.com/syscoin/electrum"
  !define PRODUCT_PUBLISHER "Blockchain Foundry Inc"
...
Section
  ...
  ;Links syscoin: URI's to Electrum
  WriteRegStr HKCU "Software\Classes\syscoin" "" "URL:syscoin Protocol"
  WriteRegStr HKCU "Software\Classes\syscoin" "URL Protocol" ""
  WriteRegStr HKCU "Software\Classes\syscoin" "DefaultIcon" "$\"$INSTDIR\electrum.ico, 0$\""
  WriteRegStr HKCU "Software\Classes\syscoin\shell\open\command" "" "$\"$INSTDIR\electrum-${PRODUCT_VERSION}.exe$\" $\"%1$\""
...
Section "Uninstall"
  ...
  DeleteRegKey HKCU "Software\Classes\syscoin"
