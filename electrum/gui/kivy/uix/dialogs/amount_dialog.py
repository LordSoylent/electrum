    ...
    AnchorLayout:
        ...
        BoxLayout:
            ...
            GridLayout:
                ...
                fiat_amount: ''
                is_fiat: False
                on_fiat_amount: if self.is_fiat: self.amount = app.fiat_to_sys(self.fiat_amount)
                on_amount: if not self.is_fiat: self.fiat_amount = app.sys_to_fiat(self.amount)
                size_hint: 1, None
            ...
            BoxLayout:
                ...
                Button:
                    ...
                    text: _('OK')
                    on_release:
                        root.callback(sys.text if kb.amount else '')
                        popup.dismiss()
''')
